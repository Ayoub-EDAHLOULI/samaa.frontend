    ...
    <footer className="border-t border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-950 pt-14 pb-10">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed max-w-xs mb-6">
              The Shazam for Quran. Identify any reciter instantly using AI-powered voice recognition.
            </p>
            <div className="flex gap-2">
              {[
                ...
                <a key={s.label} href="#" aria-label={s.label} className="w-8 h-8 rounded-lg border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-400 hover:text-sky-500 hover:border-sky-200 dark:hover:border-sky-700 transition-all duration-200">
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 pt-7 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-slate-400 dark:text-slate-500 text-xs">© 2026 Samaa. Made with ♥ for the Ummah.</p>
