  ...
  return (
    <section id="download" className="relative py-28 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-225 h-150 rounded-full bg-linear-to-b from-[#38BDF8]/8 to-transparent blur-[150px]" />
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 lg:px-8">
        <div className="relative glass-card rounded-[2.5rem] p-12 lg:p-20 overflow-hidden text-center">
          {/* Inner glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-80 h-1 bg-linear-to-r from-transparent via-[#38BDF8]/60 to-transparent" />
          ...
          >
            Free to download. No account required to try. Identify your first
            reciter in seconds.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <div className="text-xs opacity-70 leading-none mb-0.5">
                  Download on the
                </div>
          ...
          {/* Bottom inner glow */}
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-80 h-1 bg-linear-to-r from-transparent via-[#C9A845]/40 to-transparent" />
        </div>
      </div>
    </section>
  );
