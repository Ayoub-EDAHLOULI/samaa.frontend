...
const features = [
  {
    ...
    description: "Under 3 seconds from recording to result. Our model runs server-side with no cold starts.",
  ...
  },
  {
    ...
    description: "Every recognition is saved to your personal timeline. Revisit your discoveries anytime.",
  ...
  },
  {
    ...
    title: "200+ Reciters",
    description: "From Mishary Alafasy to Abdul Basit Abdus Samad — our database grows monthly.",
  ...
  },
  {
    ...
    title: "Privacy First",
    description: "Audio is processed transiently and never stored on our servers. Your listening stays yours.",
  ...
  },
  {
    ...
    title: "Offline-Ready",
    description: "Core identification works even with a slow connection. Results cache locally for repeat listens.",
  ...
  },
  {
    ...
    description: "Always know how certain Samaa is. Scores above 60% are shown; ambiguous results are flagged.",
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/50 text-lg max-w-xl mx-auto">
            Every detail crafted to make your Quran listening experience richer, deeper, and more connected.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feat, i) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${feat.gradient} border ${feat.border} flex items-center justify-center mb-5`}
              ...
              <div
                ...
                style={{ background: `linear-gradient(to right, transparent, ${feat.accent}50, transparent)` }}
              />
            </motion.div>
          ))}
        </div>
